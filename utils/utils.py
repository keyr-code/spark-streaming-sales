...
def generate_date_between(start_date=data_config.START_DATE, end_date=data_config.END_DATE):
...
def get_job_level(job_title):
    ...
    if "manager" in job_title or "director" in job_title:
        ...
        return "lead"
    elif "specialist" in job_title or "expert" in job_title or "consultant" in job_title:
        return "specialist"
