...
def main():
    ...
    parser.add_argument('--bootstrap-servers', default=kafka_config.PRODUCER_CONFIG['bootstrap.servers'],
                        help='Kafka bootstrap servers')
    parser.add_argument('-t', '--topic', default=kafka_config.PRODUCER_CONFIG['topic'],
