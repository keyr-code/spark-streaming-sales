...
class SalesDataStreamGenerator:
    def __init__(self):
        ...
        try:
            ...
            self.sales_employees = self.employees_df[
                ...
                (self.employees_df['termination_date'].isna() | (self.employees_df['termination_date'].isna()))
            ]
            
            # Group products by department
            self.products_by_dept = {}
            for dept_id in data_config.DEPT_POPULARITY.keys():
                self.products_by_dept[dept_id] = self.products_df[self.products_df['dept_id'] == dept_id]
    ...
    def generate_sale(self):
        ...
        dept_employees = self.sales_employees[self.sales_employees['dept_id'] == dept_id]
